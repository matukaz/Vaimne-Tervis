...
local webView 
local webViewHTML = "3_instruction_text.html" 
...
function backButtonRelease()
    ...
    removeWebView()
    composer.removeScene( "3_game_instructions" )   
    composer.gotoScene( "gamelist", "fade", 0 )
...
turnMusicOnOffToggleButton = ui.newButton{text="",default = "images/soundOFF.png",  over = "images/soundON.png", checked = "images/soundON.png",onRelease = f,  textColor={ 0, 0, 0, 255 }}
...
webView = native.newWebView( display.contentCenterX, statusBox.y+55, 300, (gameButton.y-gameButton.height)-(statusBox.y+55) ) -- statusBox.y real Y position + statusbox size+padding (55) - gameButton.y-backButtonHeight
